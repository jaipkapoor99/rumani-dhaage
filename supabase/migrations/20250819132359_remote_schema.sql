...
CREATE TABLE IF NOT EXISTS "public"."items" (
    ...
    "name" "text" NOT NULL,
    "description" "text",
    "type" "public"."item_type" DEFAULT 'saree'::"public"."item_type" NOT NULL,
...
CREATE INDEX "item_images_created_at_idx" ON "public"."item_images" USING "btree" ("created_at");



CREATE INDEX "item_images_item_id_idx" ON "public"."item_images" USING "btree" ("item_id");
...
CREATE INDEX "items_instock_idx" ON "public"."items" USING "btree" ((("quantity" > 0)));



CREATE UNIQUE INDEX "items_name_unique_ci" ON "public"."items" USING "btree" ("lower"("btrim"("name")));
...
CREATE OR REPLACE TRIGGER "set_updated_at" BEFORE UPDATE ON "public"."items" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE POLICY "Allow anon read item_images" ON "public"."item_images" FOR SELECT TO "anon" USING (true);



CREATE POLICY "Allow anon read items" ON "public"."items" FOR SELECT TO "anon" USING (true);



CREATE POLICY "Allow auth read item_images" ON "public"."item_images" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Allow auth read items" ON "public"."items" FOR SELECT TO "authenticated" USING (true);
...
GRANT ALL ON TYPE "public"."item_type" TO "anon";
GRANT ALL ON TYPE "public"."item_type" TO "authenticated";
